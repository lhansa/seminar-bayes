...
La referencia principal de la charla es **McElreath, *Statistical Rethinking*** (#71): se nombra de palabra en la nota del muestreo —el capítulo del rey Markov— y por eso encabeza «Para profundizar», donde se recoge, no se presenta. **Gelman y Hill se queda**, y la decisión está tomada, no heredada: entró con el radón, que ya no está en la charla, y se sostiene porque es el único de la lista que arranca en la regresión que este público ya sabe y acaba en multinivel, que es la extensión de «Lo que no ha cabido». Esa línea va escrita en la slide; si alguna vez deja de justificarse, se quita el libro, no la línea.
...
- **El guion de las preguntas está en la nota del ponente de `# leonardohansa.com`**: las once previstas, en orden de probabilidad, cada una con dónde cae —nota, slide de la charla o *backup*—. Si mueves o añades una slide de *backup*, esa nota se actualiza con ella.
- **La última slide lleva el QR, igual que la penúltima, y es a propósito**: durante veinte minutos de preguntas hay una slide proyectada delante de la sala, y es el mejor hueco de captación de la charla.
