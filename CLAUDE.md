...
- **El guion de las preguntas está en la nota del ponente de `# leonardohansa.com`**: las diez previstas, en orden de probabilidad, cada una con dónde cae —nota, slide de la charla o *backup*—. Si mueves o añades una slide de *backup*, esa nota se actualiza con ella.
