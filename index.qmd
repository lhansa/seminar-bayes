...
"Vamos a no dar la vuelta al problema", no puede pasar de la cuarta parte de la charla:
lo que se gaste ahí se lo quita al bloque de medios. "Quién soy" es un minuto: de dónde
vengo y por qué doy este seminario. No es un currículum, pero sí es la parte de empresa:
es la credencial que esta sala ha venido a comprar.
:::
