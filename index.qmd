...
paga el muestreador semanas después, cuando ya nadie se acuerda de esta slide. Y la trampa
de la trampa: la simulación previa no detecta este error, porque la mediana simulada casi
no se mueve si aprietas `mu`. Se ve en la posteriori, y lo vemos dentro de dos slides.
:::
