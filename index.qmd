...
::: {.column width="40%"}
Competencia: entre `{python} euros(hdi_competencia[0])` y `{python} euros(hdi_competencia[1])` € a la semana, con un 90 % de probabilidad.
:::
...
![https://github.com/pymc-devs/pymc-examples](img/pymc-github.png){.nostretch width="60%"}
...
::: {.column width="50%"}
![https://leonardohansa.com/regalo-bayes](img/qr.png){.nostretch width="50%"}
:::
