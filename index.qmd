...
::: {.column width="50%"}
![https://leonardohansa.com/seminar-bayes](img/diapositivas.png)
:::
...
::: {.column width="50%"}
![https://github.com/pymc-devs/pymc-examples](img/pymc-github.png)
:::
...
::: {.column width="50%"}
![Notebook de regalo con material extra.](img/notebook.png)
:::

::: {.column width="50%"}
![https://leonardohansa.com/regalo-bayes](img/qr.png)
:::
...
- Traducción online disponible:
  + https://xcelab.net/rm/
  + Notable la de Solomon Kurz.
  + Disponible la de PyMC.
:::

::: {.column width="50%"}
![Statistical Rethinking, de Richard McElreath](img/statistical-rethinking.png)
:::
