...
## Empiezo con una regresión sin medios para entender la sintaxis
...
- `mu`: es el nivel del KPI escalado.
- `gamma`: cuánto lo mueve ese control cuando sube una desviación típica.
- `sigma`: lo que queda sin explicar.

## Ahora compruebo si las prioris tienen sentido, antes de usar datos
...
## Hasta aquí la sintaxis de una regresión múltiple
...
- KPI estandarizado.
- Modelamos conversiones, no facturación.
...
- mediana `{python} f"{priori_roi.median():.2f}".replace(".", ",")`,
- el 90 % central entre `{python} f"{roi_bajo:.2f}".replace(".", ",")` y `{python} f"{roi_alto:.2f}".replace(".", ",")`, 
