...
with pm.Model(coords={"control": CONTROLES, "semana": semanas}) as esqueleto:
    ...
    gamma = pm.Normal("gamma", 0.0, 1.0, dims=CONTROLES)
    sigma = pm.Exponential("sigma", 1.0)

    media = mu + pt.dot(x_esc, gamma)
    pm.Normal("y", mu=media, sigma=sigma, observed=y_esc, dims=semanas)
```
...
- Hay metodología detrás de la elección de una priori.
- Se diagnostica antes de leer la posteriori.
- La respuesta es una distribución.
