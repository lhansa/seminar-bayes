...
![](img/Ebiquity_Logo.png){.nostretch width="50%" fig-alt="Logotipo de Ebiquity"}

![](img/cunef.png){.nostretch width="50%" fig-alt="Logotipo de CUNEF"}
...
![https://www.pymc.io/welcome.html](img/PyMC_banner.svg){.nostretch width="50%" fig-alt="Logotipo de PyMC"}
