...
::: aside
Esto es una charla, no un curso cuatrimestral, así que dejaré **muchas** cosas fuera.
:::
...
## En PyMC queda así: priori, verosimilitud y datos
...
with pm.Model() as modelo_moneda:
    p_cara = pm.Uniform("p_cara", lower=0, upper=1)    # priori
    y = pm.Binomial("y", n=100, p=p_cara, observed=60) # verosimilitud y datos
